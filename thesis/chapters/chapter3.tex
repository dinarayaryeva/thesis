...
\section{Model dynamics}
    ...
    The equation above can be further transformed \todo{why?} into standard manupulator equation form:
    $$
...
\section{Thrusters modelling}
    ...
    \todo{\#TODO Add more info. Explain the simplification}
...
\section{Summary}
    ...
    \todo{\#TODO Make a summary of the chapter}